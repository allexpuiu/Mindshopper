...
import ro.mindit.mindshopper.config.audit.AuditEventConverter;
import ro.mindit.mindshopper.domain.PersistentAuditEvent;
...
import static ro.mindit.mindshopper.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
